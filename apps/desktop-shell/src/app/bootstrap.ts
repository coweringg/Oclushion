  ...
  document.body.innerHTML = `
    <div style="display:flex;align-items:center;justify-content:center;min-height:100vh;background:#0a0a0a;color:#e4e4e7;font-family:system-ui,-apple-system,sans-serif;padding:2rem;">
      <div style="max-width:480px;text-align:center;">
        ...
        <h1 style="font-size:1.25rem;font-weight:600;margin:0 0 0.5rem;color:#fafafa;">${escapeHtml(title)}</h1>
        <p style="font-size:0.875rem;color:#a1a1aa;margin:0 0 1.5rem;line-height:1.5;">${escapeHtml(message)}</p>
